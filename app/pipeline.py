...
class TrendPipeline:
    def __init__(self, settings: Settings):
        ...
        self.x = XTrendClient(settings.x_username, settings.x_email, settings.x_password, settings.x_cookies_file)
    ...
    async def print_trends(self):
        for t in await self.collect(): print(f'{t.rank:>2}. {t.name}')
    ...
    def health(self):
        ...
        print(f'location: {self.settings.x_trends_location}')
